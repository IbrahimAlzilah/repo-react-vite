...
function AddEditPost({ post, onClose, onAdding }) {
  // States
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onAdding(formData); // Call the onAdding function passed from TodoList
      onClose();
    } catch (error) {
  ...
  if (!post) return null; // Don't render if no todo is being edited
